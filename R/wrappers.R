...
CalcSWTPower <- function(design_mat_list = NULL,
                         ...
                         crossover_time_period_vec = NULL,
  ...
  if(is.null(design_mat_list)) design_mat_list <- CreateClusterCompleteDesignMatrixList(n_study_periods,
                                                                                        n_clust_trt_seqs,
    ...
    if(is.null(cor_mat_list)) cor_mat_list <- CreateClusterCompleteCorMatList(n_study_periods,
                                                                              n_clust_per_sequence,
                                                                              n_ind_per_clust,
                                                                              within_period_corr,
                                                                              between_period_corr,
